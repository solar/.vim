...
au MyAutoCmd BufEnter c:/*.{java,php,tpl,rb,py,pl,cgi,scala,sbt} execute ":lcd " . expand("%:p:h")
au MyAutoCmd BufEnter c:/*.{txt,htm,html,css,js,xml,vim} execute ":lcd " . expand("%:p:h")
